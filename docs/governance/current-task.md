...
CURRENT_LOT    = NONE
PHASE          = MODEL0B_QUALIFICATION_NOTEBOOK_PENDING_CHATGPT_REVIEW
```
...
CURRENT_LOT                = NONE
PHASE                      = MODEL0B_QUALIFICATION_NOTEBOOK_PENDING_CHATGPT_REVIEW
PROCHAINE_ACTION_AUTORISEE = remote toy0b notebook review by ChatGPT
```
...
BRANCHE                     = master
LOT_COURANT                 = NONE
DERNIER_JALON_VALIDE        = création et exécution top-to-bottom du premier notebook de qualification exécutable de toy0b, experiments/toy0b/toy0b.ipynb, lot MODEL0B-NOTEBOOK-QUALIFICATION-1, en attente de revue ChatGPT
