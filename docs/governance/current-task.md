...
BRANCHE                     = master
LOT_COURANT                 = NONE
DERNIER_JALON_VALIDE        = LOCAL_DIMENSION et STATE_FAMILY fermés pour model0a ; implementation-design.md créé (PROPOSED_IMPLEMENTATION_DESIGN)
