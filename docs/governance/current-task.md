...
```text
CURRENT_LOT                = NONE
PHASE                      = MODEL0D_CORE_HALF_POINT_PENDING_CHATGPT_REVIEW
PROCHAINE_ACTION_AUTORISEE = remote core half-point review by ChatGPT
```
