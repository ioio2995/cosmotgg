...
PROCHAINE_ACTION_AUTORISEE  = NONE — le prochain lot scientifique/ingénierie (conception du mécanisme minimal de qualification T5-FLOW) requiert un mandat distinct
